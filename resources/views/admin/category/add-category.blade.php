                ...
                <div class="card-body">
                    ...
                    <form action="{{ url('admin/add-category')}}" method="POST">
                        ...
                        @csrf
                          ...
                          <input type="text" class="form-control" name="name" id="category" aria-describedby="emailHelp">
                        </div>

                        <div class="mb-3">
                          <label for="category" class="form-label">Slug</label>
                          <input type="text" class="form-control" name="slug" id="category" aria-describedby="emailHelp">
                        </div>
